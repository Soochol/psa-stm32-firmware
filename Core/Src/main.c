...
int main(void)
{
  ...
  //v_I2C5_Bus_Recovery_FastMode();	//low
  ...
  //sv_I2C2_Bus_Recovery_FastMode();	//low
...
static void MX_SAI1_Init(void)
{
  ...
  hsai_BlockA1.SlotInit.SlotActive = SAI_SLOTACTIVE_1;

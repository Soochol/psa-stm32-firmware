...
C_SRCS += \
../AS6221/platform/src/as6221_platform.c 

OBJS += \
./AS6221/platform/src/as6221_platform.o 

C_DEPS += \
./AS6221/platform/src/as6221_platform.d 


# Each subdirectory must supply rules for building sources it contributes
AS6221/platform/src/%.o AS6221/platform/src/%.su AS6221/platform/src/%.cyclo: ../AS6221/platform/src/%.c AS6221/platform/src/subdir.mk
...
clean: clean-AS6221-2f-platform-2f-src

clean-AS6221-2f-platform-2f-src:
	-$(RM) ./AS6221/platform/src/as6221_platform.cyclo ./AS6221/platform/src/as6221_platform.d ./AS6221/platform/src/as6221_platform.o ./AS6221/platform/src/as6221_platform.su

.PHONY: clean-AS6221-2f-platform-2f-src

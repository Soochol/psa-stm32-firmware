...
C_SRCS += \
../MLX90640/platform/src/mlx90640_platform.c 

OBJS += \
./MLX90640/platform/src/mlx90640_platform.o 

C_DEPS += \
./MLX90640/platform/src/mlx90640_platform.d 


# Each subdirectory must supply rules for building sources it contributes
MLX90640/platform/src/%.o MLX90640/platform/src/%.su MLX90640/platform/src/%.cyclo: ../MLX90640/platform/src/%.c MLX90640/platform/src/subdir.mk
...
clean: clean-MLX90640-2f-platform-2f-src

clean-MLX90640-2f-platform-2f-src:
	-$(RM) ./MLX90640/platform/src/mlx90640_platform.cyclo ./MLX90640/platform/src/mlx90640_platform.d ./MLX90640/platform/src/mlx90640_platform.o ./MLX90640/platform/src/mlx90640_platform.su

.PHONY: clean-MLX90640-2f-platform-2f-src

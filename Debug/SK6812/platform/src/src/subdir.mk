...
C_SRCS += \
../SK6812/platform/src/src/sk6812_api.c 

OBJS += \
./SK6812/platform/src/src/sk6812_api.o 

C_DEPS += \
./SK6812/platform/src/src/sk6812_api.d 


# Each subdirectory must supply rules for building sources it contributes
SK6812/platform/src/src/%.o SK6812/platform/src/src/%.su SK6812/platform/src/src/%.cyclo: ../SK6812/platform/src/src/%.c SK6812/platform/src/src/subdir.mk
...
clean: clean-SK6812-2f-platform-2f-src-2f-src

clean-SK6812-2f-platform-2f-src-2f-src:
	-$(RM) ./SK6812/platform/src/src/sk6812_api.cyclo ./SK6812/platform/src/src/sk6812_api.d ./SK6812/platform/src/src/sk6812_api.o ./SK6812/platform/src/src/sk6812_api.su

.PHONY: clean-SK6812-2f-platform-2f-src-2f-src

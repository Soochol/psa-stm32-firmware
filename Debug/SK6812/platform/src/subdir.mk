...
C_SRCS += \
../SK6812/platform/src/sk6812_platform.c 

OBJS += \
./SK6812/platform/src/sk6812_platform.o 

C_DEPS += \
./SK6812/platform/src/sk6812_platform.d 


# Each subdirectory must supply rules for building sources it contributes
SK6812/platform/src/%.o SK6812/platform/src/%.su SK6812/platform/src/%.cyclo: ../SK6812/platform/src/%.c SK6812/platform/src/subdir.mk
...
clean: clean-SK6812-2f-platform-2f-src

clean-SK6812-2f-platform-2f-src:
	-$(RM) ./SK6812/platform/src/sk6812_platform.cyclo ./SK6812/platform/src/sk6812_platform.d ./SK6812/platform/src/sk6812_platform.o ./SK6812/platform/src/sk6812_platform.su

.PHONY: clean-SK6812-2f-platform-2f-src
